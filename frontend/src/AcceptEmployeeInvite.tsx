...
export const AcceptEmployeeInvite: React.FC = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`/api/v1/employee-invite/verify?token=${encodeURIComponent(t)}`)
      .then((res) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await axios.post("/api/v1/employee-invite/accept", { token, password });
  ...
  const orgLabel = inviteInfo?.businessUnitLabel || inviteInfo?.businessUnit;
    ...
    <div style={styles.page}>
      <div style={styles.card}>
        <div style={styles.header}>
          ...
          <h1 style={styles.title}>Join Nexa AI</h1>
        </div>

        {verifyState === "loading" && (
          <div style={styles.centerBlock}>
            <FiLoader size={32} style={{ animation: "spin 1s linear infinite", color: "#ed0000" }} />
            <p style={styles.hint}>Verifying your invitation…</p>
          </div>
        )}
        ...
        {verifyState === "invalid" && (
          <div style={styles.centerBlock}>
            ...
            <p style={styles.hint}>Ask your administrator for a new invitation.</p>
          </div>
        )}
        ...
        {verifyState === "valid" && submitState === "success" && (
          <div style={styles.centerBlock}>
            ...
            <h2 style={styles.stateTitle}>You&apos;re all set</h2>
            <p style={styles.hint}>
              Your Nexa account for <strong>{orgLabel}</strong> is ready.
            </p>
            <p style={styles.hint}>Sign in with your email and the password you just created.</p>
          ...
          <>
            <div style={styles.infoBox}>
              ...
              <p style={styles.infoRow}>
                ...
                <span style={styles.infoValue}>{orgLabel}</span>
              </p>
            </div>

            <p style={styles.subtitle}>Choose a password to finish creating your account.</p>
