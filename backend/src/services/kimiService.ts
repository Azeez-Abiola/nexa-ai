...
export async function* streamAIResponse(
  ...
  logger.info("[Kimi/Stream] Request", { model: MODEL, connectors: Boolean(toolContext) });
  ...
  // model and prompt are Kimi-specific, and they are all above this line.
  yield* streamWithTools({
    ...
    toolContext,
    onUsage: (usage) =>
      recordUsage({ businessUnit, provider: "kimi", modelId: MODEL, usage, mode: "stream" })
  });
}
