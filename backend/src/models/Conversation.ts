...
export interface ChatMessage {
  ...
  senderName?: string;
  /**
   * Marks a voice call boundary rather than something anybody said. The client renders
   * these as a divider in the transcript, not a chat bubble. Role stays "assistant"
   * only because the schema allows no third value; nothing here was generated by a model.
   */
...
const MessageSchema = new Schema<ChatMessage>(
  {
    ...
    callLog: {
      type: new Schema({ durationSeconds: { type: Number, required: true } }, { _id: false }),
      default: undefined,
    },
  },
  { _id: false }
